...
# Tenta buscar por TOKEN ou por DISCORD_TOKEN para evitar erros de digitação no .env
...
if not TOKEN:
    ...
    print("="*50 + "\n")
    # Encerra o script de forma limpa antes do erro de tipo
    os._exit(1)
    ...
    async with ctx.typing():
        ...
        if is_banned:
            ...
            embed.description = (
                ...
                f"{'This account was confirmed for using cheats.' if lang == 'en' else 'Ce compte a été confirmé como utilizando hacks.'}\n"
        ...
        embed.set_footer(text="DEVELOPED BY CORLEONE•")
